...
export const NodePanel: FC<NodePanelRenderProps> = (props) => {
  ...
  const enableNodePlaceholder = (panelProps as any)?.enableNodePlaceholder;
  const allowedTypes = (panelProps as any)?.allowedTypes as Array<string> | undefined;
  ...
  return (
    <Popover
      ...
      content={<NodeList onSelect={onSelect} allowedTypes={allowedTypes} />}
      placement="right"
