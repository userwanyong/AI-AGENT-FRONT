...
export const LineAddButton = (props: LineRenderProps) => {
  ...
  const onClick = useCallback(async () => {
    ...
    // determine source node type via registry - 通过来源端口的节点注册器判断类型
    ...
    const isFromAgent = srcType === 'agent';
    const isFromModel = srcType === 'model';
    const isFromClient = srcType === 'client';
